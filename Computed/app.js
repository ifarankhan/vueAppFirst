const app = Vue.createApp({
      ...
      Books: [
        {
          ...
          author: "Faran K",
          article:
            "Multilingual writers often find article usage to be one of the most difficult concepts to learn. Although there are some rules about article usage to help, there are also quite a few exceptions. Therefore, learning to use articles accurately takes a long time. To master article usage, it is necessary to do a great deal of reading, notice how articles are used in published texts, and take notes that can apply back to your own writing.",
          age: 30,
          images: "../assets/1.jpg",
          fav: true,
        },
  ...
  methods: {
    handleToggleFav(e, data) {
      this.Books[e].fav = !data;
    },
